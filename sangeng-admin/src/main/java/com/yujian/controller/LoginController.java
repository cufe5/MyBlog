...
import com.yujian.domain.vo.AdminUserInfoVo;
import com.yujian.domain.vo.MenuVo;
import com.yujian.domain.vo.RoutersVo;
...
import com.yujian.service.LoginService;
...
public class LoginController {
    ...
    public ResponseResult<AdminUserInfoVo> getInfo(){
        ...
        //根据用户id查询权限信息
        List<String> perm = menuService.selectPermsKeyByUserId(loginUser.getUser().getId());
        ...
        //封装数据返回
        AdminUserInfoVo adminUserInfoVo = new AdminUserInfoVo(perm,roleKeyList,userInfoVo);
